    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="card flex items-center p-6 gap-4">
          <div className="bg-primary/10 p-4 rounded-xl text-primary" style={{ backgroundColor: 'var(--accent-light)', color: 'var(--accent)', padding: '16px', borderRadius: '12px' }}>
            <Building2 size={32} />
          </div>
          <div>
            <p className="text-sm text-gray-500 font-medium" style={{ color: 'var(--text-secondary)' }}>Toplam Restoran (Müşteri)</p>
            <h2 className="text-3xl font-bold" style={{ color: 'var(--text-primary)', fontSize: '2rem', fontWeight: 800 }}>{stats.totalTenants}</h2>
          </div>
        </div>
      </div>
    </div>
