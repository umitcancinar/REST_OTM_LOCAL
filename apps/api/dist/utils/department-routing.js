...
exports.STATION_PRINT_DEPARTMENTS = exports.GRILL_STATION_DEPARTMENTS = exports.KITCHEN_STATION_DEPARTMENTS = void 0;
exports.resolvePreparationDepartment = resolvePreparationDepartment;
/**
 * PRODUCTION departments that go to a physical kitchen station.
 * BAR (içecek) is intentionally excluded — beverages print nowhere.
 */
exports.KITCHEN_STATION_DEPARTMENTS = new Set([
    'KITCHEN',
    'COLD',
    'PASTRY',
]);
exports.GRILL_STATION_DEPARTMENTS = new Set([
    'GRILL',
]);
/** All departments that require a physical station print (not BAR/CASHIER/PAKET/POS). */
exports.STATION_PRINT_DEPARTMENTS = new Set([
    'KITCHEN',
    'COLD',
    'PASTRY',
    'GRILL',
 ...
 */
function resolvePreparationDepartment(storedDepartment, categoryName) {
    const department = (storedDepartment || 'KITCHEN');
    ...
    if (/(izgara|mangal|ocakbasi|ocak)/.test(cat))
        return 'GRILL';
    // İçecek / Meşrubat / Bar / Soğuk İçecek → BAR (not printed to any kitchen)
    if (/(icecek|mesrubat|\bbar\b|soguk|sicak icecek|cay|kahve|ayran|kola|su\b)/.test(cat))
        return 'BAR';
    return department;
}
//# sourceMappingURL=department-routing.js.map