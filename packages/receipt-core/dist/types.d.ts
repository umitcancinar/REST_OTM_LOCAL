 ...
 */
export declare const RENDER_ENGINE_VERSION = 2;
/** 203 DPI termal yazıcı: 1 mm ≈ 8 nokta */
export declare const DOTS_PER_MM: number;
/** ESC/POS varsayılan satır yüksekliği (nokta). Önizleme ile ortak. */
export declare const LINE_HEIGHT_DOTS = 24;
export declare const PAPER_COLUMNS: Record<PaperWidth, number>;
export declare const PAPER_PIXELS: Record<PaperWidth, number>;
/** Basilabilir alan (mm): 58 mm kagitta ~48 mm, 80 mm kagitta ~72 mm. Onizleme ile ortak. */
export declare const PRINTABLE_MM: Record<PaperWidth, number>;
/** Fişteki tek tek ayarlanabilen öğeler. */
export type ElementKey = 'logo' | 'header' | 'subHeader' | 'title' | 'customer' | 'orderNote' | 'dateTime' | 'table' | 'orderNo' | 'waiter' | 'columnsHeader' | 'item' | 'itemNote' | 'total' | 'paymentMethod' | 'payments' | 'remaining' | 'paidItems' | 'cancelTitle' | 'treatTitle' | 'footer';
export declare const ELEMENT_KEYS: ElementKey[];
/** Kullanıcıya gösterilen Türkçe öğe adları (admin UI için). */
export declare const ELEMENT_LABELS: Record<ElementKey, string>;
