...
export const PROFILES = Object.freeze({
  local: Object.freeze({
    ...
    forbiddenPaths: Object.freeze([
      ...
      /(?:^|\/)modules\/license(?:\/|$)/i,
      /(?:^|\/)modules\/cloud-update(?:\/|$)/i,
      /(?:^|\/)modules\/public\/public-cloud\.controller\.js$/i,
      /(?:^|\/)@rest-otm\/license\/(?:src|dist)\/sign\.js$/i,
      /(?:^|\/)modules\/[^/]*(?:signer|signing)[^/]*\.js$/i,
    ...
    forbiddenText: Object.freeze([
      ...
      /(?:^|[^A-Z0-9_])UPDATE_SIGNING_(?:PRIVATE|PUBLIC)_KEY(?:[^A-Z0-9_]|$)/,
  ...
  cloud: Object.freeze({
    ...
    forbiddenPaths: Object.freeze([
      ...
      /(?:^|\/)modules\/local-update\/(?!local-update\.contract\.js$)[^/]+\.js$/i,
      /(?:^|\/)print-agent(?:\/|$)/i,
      /(?:^|\/)receipt-core(?:\/|$)/i,
      /(?:^|\/)websocket(?:\/|$)/i,
